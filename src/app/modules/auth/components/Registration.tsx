  ...
  return (
    ...
    >
      ...
      <div className='mb-10 text-center'>
        {/* begin::Title */}
        <h1 className='text-dark mb-3'>Kreirajte korisnički račun</h1>
        {/* end::Title */}
      ...
      <div className='row fv-row mb-7'>
        <div className='col-xl-6'>
          <label className='class="form-label fw-bolder text-dark fs-6'>Ime</label>
          <input
            placeholder='Ime'
            type='text'
            autoComplete='off'
        ...
        <div className='col-xl-6'>
          ...
          <div className='fv-row mb-5'>
            <label className='form-label fw-bolder text-dark fs-6'>Prezime</label>
            <input
              placeholder='Prezime'
              type='text'
              autoComplete='off'
      ...
      <div className='fv-row mb-7'>
        <label className='form-label fw-bolder text-dark fs-6'>Broj telefona</label>
        <input
      ...
      <div className='mb-10 fv-row' data-kt-password-meter='true'>
        <div className='mb-1'>
          <label className='form-label fw-bolder text-dark fs-6'>Lozinka</label>
        ...
        <div className='text-muted'>
          Koristite lozinku sa 8 ili više karaktera, kombinacija slova, brojeva i simbola
        </div>
      </div>
      {/* end::Form group */}
      ...
      <div className='fv-row mb-5'>
        <label className='form-label fw-bolder text-dark fs-6'>Potvrdi lozinku</label>
        <input
          type='password'
