...
export function Sessions() {
 ...
 useEffect(()=>{
    ...
    getUserActiveSessions(getStorageAccessToken()).then((response:any)=>{
...
<div className="card-body p-0">
    ...
    return <tr key={index}>
    <td>
        <a href="#" className="text-hover-primary text-gray-600">{session.applicationNames}</a>
    </td>
    ...
    <td>
        ...
        <span className="badge badge-light-success fs-7 fw-bolder">Aktivno</span>
        }
         { session.isCurrentSession == false &&
        <span className="badge badge-light-danger fs-7 fw-bolder">Neaktivno</span>
        }
    </td>
</tr>
                })
