...
const addressesSchema = Yup.object().shape({
  ...
  addressType: Yup.string().required('Tip je obavezan'),
})
              ...
              <div className='form-group row' id='kt_repeater_1'>
                <div data-repeater-list='' className='col-lg-9'>
                  ...
                  >
                    ...
                    <div className='col-md-2 btn-group mt-3 mt-md-0'>
                ...
                <div
                  data-repeater-list=''
                  className='col-lg-3 form-group row align-items-center mt-3 mt-md-0  d-flex align-items-center'
                >
                  <div className='col-md-10 btn-group'>
                    <button
                      onClick={() => props.editHandler(false)}
                      type='button'
                    ...
                    >
                      <i className='la la-check' style={{color: 'white'}}></i>Spasi
                    </button>
                  </div>
                </div>
              </div>
